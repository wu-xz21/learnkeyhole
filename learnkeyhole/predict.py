...
def predictaction(inmode,open_path,save_path,model_path):
    #-------------------------------------------------------------------------#
    ...
    name_classes    = ["background","keyhole"]
    #----------------------------------------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        while True:
            ...
            try:
                ...
                #r_image.show()
                image_name = os.path.basename(open_path)
        ...
        video_path      = open_path
        video_name = os.path.basename(open_path)
...
# predictaction("dir_predict",img_path,save_path)
# end=time.perf_counter()
# print("总预测时间为：%s s"%(end-start))
